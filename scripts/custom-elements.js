...
const services = [
    {
        text: "Photography",
        href: "booking.html?service=photography",
    },
    {
        text: "Videography",
        href: "booking.html?service=videography",
    },
];
...
function createFooter() {
    ...
    // const $brandTitle = $("<h3>", { text: "Drone Design" });
    const $brandLogo = $("<img>", {
    ...
    $brandSection.append([$brandLogo, $brandText]);
